    ...
    function($scope, $routeParams, $http) {
      ...
      $http.get('api/emails/'+$routeParams.emailUuid)
        .then(function(res) {
          ...
          $scope.htmlDataUrl = "data:text/html;charset=UTF-8;base64,"+btoa(unescape(encodeURIComponent(res.data.html)));
        })
      ;
